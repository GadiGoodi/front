  ...
  return (
    <>
      <div className="py-3 transform transition-transform ease-in-out duration-300 hover:scale-105">
        <Link href={'/'}>
          <div className="bg-[#2C2C2C] w-[100%] h-[20%] text-white p-4 rounded-tl-2xl rounded-tr-2xl shadow-lg flex flex-col justify-center">
          ...
          <div className="text-overflow bg-white w-[100%] h-[130px] py-[6px] px-3 rounded-bl-2xl rounded-br-2xl shadow-lg">
            {}I'm like some kind of supernova Watch out Look at me go, 재미 좀
            볼 빛의 core, so hot, hot 문이 열려 서로의 존재를 느껴 마치 Discord,
            날 닮은 너 (incoming!), 너 누구야? (Drop) 사건은 다가와, ah-oh, ayy
