...
const Login = () => {
  ...
  return (
    <>
      <div className="bg-[#2C2C2C] w-[520px] grid place-items-center rounded-lg">
        <div className="w-[470px] my-20 grid place-items-center gap-5">
          ...
          <div className="flex">
            ...
            <button className="text-blue-600 font-bold">회원가입 하기</button>
          </div>
        </div>
      </div>
    </>
