  ...
  return (
    <>
      <div className="w-[400] h-[250] bg-[#FFFFFF] rounded-lg flex-col justify-center items-center">
        <div className="text-[#EA4B48] text-2xl font-bold pt-5 ml-5 border-b pb-5">(닉네임)님 글 삭제</div>
        <div className="flex-col justify-center items-center ml-12">
          ...
          <div className="flex justify-center items-center gap-3 mt-5">
            <button className="bg-[#2388FF] w-[130] h-[45] rounded-full text-white">삭제 및 정지</button>
            <button onClick={() => setIsAdminDelete(false)} className="bg-[#FC7373] w-[130] h-[45] rounded-full text-white">취소</button>
          </div>
        </div>
      </div >
    </>
