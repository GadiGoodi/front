import useParticipations from "@/app/(hooks)/mypage/participations/useParticipations";
                    ...
                    <div className="flex justify-between">
                        ...
                        <div className="flex relative">
                            {participants.map((participant, index) => (
                                <div className={`absolute flex items-center justify-center gap-[2px] -translate-x-[20px] -traslate-x-[${index + 1 * 10}px] z-[${index}]`}>
