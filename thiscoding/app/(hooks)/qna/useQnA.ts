...
const useQnA = () => {
  ...
  */
  ...
  return {
    ...
    qnaDetail, postTagComment, toggleTagReply, setMarkDown, markDown, setCommentContent,
    setPostTagComment, ReplyHandler, isReply, postTagReply, getQnaList, setIsReply, fetchComment, setContent,
    setImage, createQnA, getUrlImage, fetchQnaDetail, commentList, setQnaData, qnaData, enterComment, commentContent
  }
