...
import NoticesContent from '../item/NoticesContent';

const Notices = () => {
  return (
    <div className="flex-col flex justify-center items-center bg-gray-100">
      ...
      <div className="w-[950] h-[650] bg-[#FFFFFF] rounded-2xl mt-5 border-[#EBEBEB] relative">
        <div className="flex justify-end w-full h-[30] pr-7 pt-5 font-thin">
