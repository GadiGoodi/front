        ...
        <td className="flex justify-center items-center h-[45] text-center">
          <div>
            <div
              ...
              className="flex justify-center items-center rounded-full w-[70] h-[30] bg-[#444444] text-white"
            >
              {notices.category}
            </div>
          </div>
        </td>
        <td className="text-center" onClick={NoticesDetailRouter}>
          {notices.title}
        </td>
        <td className="text-center">{notices.createDate}</td>
        <td className="text-center">{notices.viewCount}</td>
        <td className="text-center">
          <button onClick={() => removeAdminNotices(notices.id)}>
            <DeleteIcon />
          </button>
        </td>
      </tr>
