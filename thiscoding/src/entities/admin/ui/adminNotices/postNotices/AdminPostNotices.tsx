        ...
        <div className="flex justify-center items-center ">
          <div className="w-[950] h-[600] flex justify-center items-center relative">
            <div className="flex gap-5 absolute top-5">
              <div className="flex-col">
                ...
                <select
                  ...
                  className="border w-[200] h-[40] px-5 py-2 rounded-md shadow-xl"
                  value={postNoticesDetail?.category}
                >
            ...
            <textarea
              ...
              cols={40}
              rows={80}
              className="w-[720] h-[400] rounded-xl shadow-xl resize-none"
            />
          </div>
        </div>
        <Link href="/admin/notices">
          <div className="absolute bottom-8 right-[130] flex">
            {!postNoticesDetail ? (
              ...
              <div
                onClick={() =>
                  modifyAdminNotices(Number(noticesId), noticeData)
                }
                className="w-[75px] h-[45px] shadow-xl bg-[#0095E8] mr-5 text-white flex justify-center items-center rounded-2xl border border-[#D0D0D0]"
              >
                수정
