...
import QnAContent from '../../entities/board/qna/ui/item/QnAContent';
      ...
      <div className="w-full flex justify-center items-center">
        <div className="flex-col">
          <div className="w-[1200] flex justify-between">
            ...
            <input
              type="text"
              className="rounded-lg shadow-xl w-[700] border-black border"
            />
            <button className="w-[90] h-[40] rounded-xl bg-[#0095E8] flex justify-center items-center text-white">
              검색
            </button>
          </div>
          <div className="w-[1200] flex justify-between items-center my-5">
            ...
            <Link href="/qna/post-qna">
              <div className="w-[90] h-[40] rounded-xl border border-black flex justify-center items-center text-[#0095E8]">
                글쓰기
              </div>
            </Link>
          </div>
      ...
      <div className="w-full flex justify-center">
        <div className="w-[1200] h-full flex justify-between">
          <div className="flex-col justify-between h-full">
            <div className="w-[250] h-[230] border border-[#EBEBEB] shadow-xl rounded-lg pt-3 pl-3 mb-5">
              실시간 인기 검색어
            </div>
            <div className="w-[250] h-[340] border border-[#EBEBEB] shadow-xl rounded-lg pt-3 pl-3">
              인기 답변 TOP 10
            </div>
          </div>
          <div className="cursor-pointer">
            <div className="border-t border-0.5 border-black w-full " />
            {qnaList?.map((qna) => <QnAContent key={qna.qnaId} qna={qna} />)}
          </div>
        </div>
      </div>
    </div>
